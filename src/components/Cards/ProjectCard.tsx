...
const ProjectCard: React.FC<ProjectCardProps> = ({ title, description, className, imgSrc, onClick, technologies, links }) => {
    return (
        <div className={`bg-white rounded shadow-lg border-l-4 border-[var(--primary-colour)] relative mb-4 sm:mb-0 pb-10 sm:hover:shadow-xl transition-all duration-300 sm:hover:scale-101 transform `+ className} onClick={onClick}>
