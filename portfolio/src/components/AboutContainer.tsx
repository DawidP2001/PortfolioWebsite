...
const AboutContainer: React.FC<AboutContainerProps> = ({className, title, description, imgSrc, imgClassName, imgStyle}) => {
    return (
        <div className={"about-container cursor-pointer flex flex-col items-start relative text-gray-800 text-left bg-white rounded-lg shadow-md p-4 border-l-4 border-red-400 pr-20  transition-all duration-300 sm:hover:scale-105 transform " + className}>
