...
const ContactSection: React.FC<ContactSectionProps> = ({className}) => {
    return (
        <section className={"contact-section my-2 p-4 " + className}>
            ...
            <p className="text-[var(--text-colour)]">If you'd like to get in touch, feel free to reach out!</p>
            ...
            <p className="text-left mt-5 text-colour">or email me at: <a className="text-blue-400 underline" href="mailto:dawidpionk01@gmail.com">dawidpionk01@gmail.com</a></p>
        </section>
    );
};
